...
def run(args):
    # 建议在 args 中增加 Support 和 Diversity 的相关配置
    # 例如: args.xi_margin = 1.0, args.pool_factor = 20 等
    # 这里假设 args 已经包含了必要的配置，或者使用 Finetune_library 中的默认值

    best_f1 = 0
    best_epoch = 0
    string1 = ''
    string2 = ''    
    print('==> Preparing data (FedUSPS Mode)..')
    
    # ... (Dataset setup code remains same) ...
    ...
    for epoch_it in range(args.epoches // args.worker_steps):        
        ...
        for ws in range(args.worker_steps): 
            ...
            for client_idx in range(args.client_num):
                ...
                # Training using FedUSPS strategy (Support & Diversity)
                # train 函数内部已经集成了新的逻辑
        ...
        # Communication step: Aggregate Support Prototypes & Distributions
        ...
        if osr_f1 > best_f1:
            ...
            print(f'Saving best model (FedUSPS optimized). . . . . . . .')
            print()
        epoch += 1
    
    print('------>Best performance (FedUSPS)--->>>>>>')
    print()
    print(string1)
    print(string2)
    print('=====================================================================================================================================')